...
| ~~Advertências (KPI da home)~~ | ✅ **QUITADA em 09/09/2026** — passou a obedecer ao filtro (pedido do dono). Era o último número da fileira que não obedecia: mostrava **820** em "30 dias" e **820** em "1 a 9 de setembro". A sparkline saiu junto, porque desenhava o acumulado mês a mês — curva que só sobe embaixo de um número que anda com o filtro |

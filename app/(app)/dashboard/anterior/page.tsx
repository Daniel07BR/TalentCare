...
export default function DashboardAnterior() {
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 20, marginBottom: 24 }}>
        <div>
          <div style={{ fontSize: 12, color: 'var(--text-dim)', fontWeight: 500, marginBottom: 4, display: 'flex', alignItems: 'center', gap: 10 }}>
            Painel de
            {/* ⚠️ A VERSÃO ANTERIOR (11/09/2026): o painel novo virou `/dashboard`
                com o OK do dono e do crítico. Esta fica por endereço, sem porta
                na tela, para comparar — como o `/completo` do relatório do setor. */}
            <Link href="/dashboard" style={{ fontSize: 11, fontWeight: 700, color: 'var(--accent)', border: '1px solid var(--border)', borderRadius: 20, padding: '2px 9px' }}>
              Versão anterior · ir para o painel atual ›
            </Link>
          </div>
